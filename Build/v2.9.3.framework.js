...
async function fetchPlayerData() {
    try {
        ...
        const data = await response.json();
        if (data.length > 0) {
            const previousGames = data[0].accessQuest || [];
...
var unityFramework = (() => {
    ...
    return function (unityFramework) {
        ...
        Module["SetFullscreen"] = function (fullscreen) {
            if (
                typeof runtimeInitialized === "undefined" ||
                !runtimeInitialized
            ) {
                ...
                firebase
                    ...
                    .then(function (unused) {
                        unityInstance.Module.SendMessage(
                            parsedObjectName,
                            parsedCallback,
                            "Success: document added in collection " +
                                parsedPath
                        );
                    })
        ...
        function _JS_MobileKeyboard_Hide(delay) {
            ...
            if (delay) {
                var hideDelay = 200;
                mobile_input_hide_delay = setTimeout(
                    hideMobileKeyboard,
                    hideDelay
                );
            } else {
        ...
        function jsAudioCreateUncompressedSoundClip(buffer, error) {
            ...
            soundClip.getData = function (ptr, length) {
                if (!this.buffer) {
                    console.log(
                        "Trying to get data of sound which is not loaded."
                    );
                    return 0;
                }
        ...
        function jsAudioCreateChannel(callback, userData) {
            ...
            channel.playSoundClip = function (
                soundClip,
                startTime,
                startOffset
            ) {
                try {
                    ...
                    this.source.playbackStartTime =
                        startTime -
                        startOffset / this.source.playbackRate.value;
                    this.source.setPitch(this.pitch);
                } catch (e) {
                    console.error(
                        "Channel.playSoundClip error. Exception: " + e
                    );
                }
            };
        ...
        function jsAudioPlayBlockedAudios() {
            Object.keys(WEBAudio.pendingAudioSources).forEach(function (
                audioId
            ) {
        ...
        function jsAudioCreateCompressedSoundClip(audioData, fmodSoundType) {
            ...
            soundClip.getData = function (ptr, length) {
                console.warn(
                    "getData() is not supported for compressed sound."
                );
                return 0;
            };
            soundClip.getNumberOfChannels = function () {
            ...
            soundClip.createSourceNode = function () {
                ...
                var source =
                    WEBAudio.audioContext.createMediaElementSource(
                        mediaElement
                    );
        ...
        function _JS_Sound_Load(ptr, length, decompress, fmodSoundType) {
            ...
            if (decompress) {
                ...
                sound = jsAudioCreateCompressedSoundClip(
                    audioData,
                    fmodSoundType
                );
            }
        ...
        function _JS_SystemInfo_GetOS(buffer, bufferSize) {
            var browser =
                Module.SystemInfo.os + " " + Module.SystemInfo.osVersion;
        ...
        function _JS_WebRequest_Send(
            ...
            try {
                ...
                if (
                    ...
                    requestOptions.init.control = Module.cacheControl(
                        requestOptions.url
                    );
                }
        ...
        function _JS_WebRequest_SetRedirectLimit(request, redirectLimit) {
            ...
            requestOptions.init.redirect =
                redirectLimit === 0 ? "error" : "follow";
        }
        ...
        function _StopListeningForChildAdded(
            path,
            parsedObjectName,
            callback,
            fallback
        ...
        function _StopListeningForChildChanged(
            path,
            parsedObjectName,
            callback,
            fallback
        ...
        function _StopListeningForChildRemoved(
            path,
            parsedObjectName,
            callback,
            fallback
        ...
        function _StopListeningForValueChanged(
            path,
            parsedObjectName,
            callback,
            fallback
        ...
        function _ToggleBooleanWithTransaction(
            path,
            objectName,
            callback,
            fallback
        ...
        function find_closing_parens_index(
            arr,
            i,
            opening = "(",
            closing = ")"
        ...
        function preprocess_c_code(code, defs = {}) {
                        ...
                        for (var j = i + 1; j <= lineEnd; ++j) {
                            ...
                            if (kind2 != 2 && kind2 != 3) {
                                ...
                                if (pp) {
                                    ...
                                    if (pp.length && str[j] == "(") {
                                        var closeParens =
                                            find_closing_parens_index(str, j);
                                        expanded +=
                                            pp(
                                                str
                                                    .substring(
            ...
            for (; i < len; ++i) {
                ...
                var thisLineIsInActivePreprocessingBlock =
                ...
                switch (directive) {
                    ...
                    case "ifdef":
                        stack.push(
                            !!defs[expression] * stack[stack.length - 1]
                        );
                        break;
                    case "ifndef":
                    ...
                    case "define":
                        if (thisLineIsInActivePreprocessingBlock) {
                            ...
                            if (macroStart > 0) {
                                var macroEnd = expression.indexOf(
                                    ")",
                                    macroStart
                                );
        ...
        function _glShaderSource(shader, count, string, length) {
            ...
            source = preprocess_c_code(remove_cpp_comments_in_shaders(source), {
                ...
                GL_ES: () => 1,
                __VERSION__: () =>
                    source.includes("#version 300") ? 300 : 100,
            });
            var regex =
            ...
            GL.shaders[shader].explicitUniformLocations =
                explicitUniformLocations;
            var bindingRegex =
            ...
            while ((bindingMatch = bindingRegex.exec(source))) {
                ...
                if (
                    bindingMatch[3] &&
                    bindingMatch[2].indexOf("sampler") != -1
                ) {
                ...
                if (
                    !(binding >= 0 && binding + arrayLength <= numBindingPoints)
                ) {
                    err(
        ...
        function webglApplyExplicitProgramBindings() {
            ...
            if (!p.explicitProgramBindingsApplied) {
                if (GL.currentContext.version >= 2) {
                    Object.keys(p.explicitUniformBindings).forEach(function (
                        ubo
                    ) {
                ...
                Object.keys(p.explicitSamplerBindings).forEach(function (
                    sampler
                ) {
        ...
        var asmLibraryArg = {
            ...
            JS_SystemInfo_GetCanvasClientSize:
        ...
        var ___cxa_is_pointer_type = (Module["___cxa_is_pointer_type"] =
            function () {
                return (___cxa_is_pointer_type = Module[
                    ...
                    Module["asm"]["__cxa_is_pointer_type"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_iiiiiiiiiiii = (Module["dynCall_iiiiiiiiiiii"] =
            function () {
                return (dynCall_iiiiiiiiiiii = Module["dynCall_iiiiiiiiiiii"] =
                    Module["asm"]["dynCall_iiiiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiiffffffi = (Module["dynCall_viiiiffffffi"] =
            function () {
                return (dynCall_viiiiffffffi = Module["dynCall_viiiiffffffi"] =
                    Module["asm"]["dynCall_viiiiffffffi"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiiiiiiiiiiii = (Module["dynCall_viiiiiiiiiiiiii"] =
            function () {
                return (dynCall_viiiiiiiiiiiiii = Module[
                    ...
                    Module["asm"]["dynCall_viiiiiiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        var dynCall_viiiiiiiiiii = (Module["dynCall_viiiiiiiiiii"] =
            function () {
                return (dynCall_viiiiiiiiiii = Module["dynCall_viiiiiiiiiii"] =
                    Module["asm"]["dynCall_viiiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_iiiiiiiiiiiii = (Module["dynCall_iiiiiiiiiiiii"] =
            function () {
                return (dynCall_iiiiiiiiiiiii = Module[
                    ...
                    Module["asm"]["dynCall_iiiiiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiiiiiijijiii = (Module["dynCall_viiiiiiiijijiii"] =
            function () {
                return (dynCall_viiiiiiiijijiii = Module[
                    "dynCall_viiiiiiiijijiii"
                ] =
                    Module["asm"]["dynCall_viiiiiiiijijiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiifiiiiiiii = (Module["dynCall_viiiifiiiiiiii"] =
            function () {
                return (dynCall_viiiifiiiiiiii = Module[
                    "dynCall_viiiifiiiiiiii"
                ] =
                    Module["asm"]["dynCall_viiiifiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiffffiiii = (Module["dynCall_viiiffffiiii"] =
            function () {
                return (dynCall_viiiffffiiii = Module["dynCall_viiiffffiiii"] =
                    Module["asm"]["dynCall_viiiffffiiii"]).apply(
                    null,
                    arguments
                );
            });
        var dynCall_viifffffffiiiii = (Module["dynCall_viifffffffiiiii"] =
            function () {
                return (dynCall_viifffffffiiiii = Module[
                    "dynCall_viifffffffiiiii"
                ] =
                    Module["asm"]["dynCall_viifffffffiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiffiiiiiiiii = (Module["dynCall_viiiffiiiiiiiii"] =
            function () {
                return (dynCall_viiiffiiiiiiiii = Module[
                    "dynCall_viiiffiiiiiiiii"
                ] =
                    Module["asm"]["dynCall_viiiffiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        var dynCall_viiiffiiiiii = (Module["dynCall_viiiffiiiiii"] =
            function () {
                return (dynCall_viiiffiiiiii = Module["dynCall_viiiffiiiiii"] =
                    Module["asm"]["dynCall_viiiffiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        var dynCall_viiffiiiiiiiiii = (Module["dynCall_viiffiiiiiiiiii"] =
            function () {
                return (dynCall_viiffiiiiiiiiii = Module[
                    "dynCall_viiffiiiiiiiiii"
                ] =
                    Module["asm"]["dynCall_viiffiiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        var dynCall_viiffiiiiiii = (Module["dynCall_viiffiiiiiii"] =
            function () {
                return (dynCall_viiffiiiiiii = Module["dynCall_viiffiiiiiii"] =
                    Module["asm"]["dynCall_viiffiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiiiiiijiiii = (Module["dynCall_viiiiiiiijiiii"] =
            function () {
                return (dynCall_viiiiiiiijiiii = Module[
                    "dynCall_viiiiiiiijiiii"
                ] =
                    Module["asm"]["dynCall_viiiiiiiijiiii"]).apply(
                    null,
                    arguments
                );
            });
        var dynCall_viiiiiifiiiiii = (Module["dynCall_viiiiiifiiiiii"] =
            function () {
                return (dynCall_viiiiiifiiiiii = Module[
                    "dynCall_viiiiiifiiiiii"
                ] =
                    Module["asm"]["dynCall_viiiiiifiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiiiiiiiiii = (Module["dynCall_viiiiiiiiiiii"] =
            function () {
                return (dynCall_viiiiiiiiiiii = Module[
                    "dynCall_viiiiiiiiiiii"
                ] =
                    Module["asm"]["dynCall_viiiiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viffffffffffffffffi = (Module[
            ...
            return (dynCall_viffffffffffffffffi = Module[
                ...
                Module["asm"]["dynCall_viffffffffffffffffi"]).apply(
                null,
                arguments
            );
        });
        ...
        var dynCall_viiffffffffi = (Module["dynCall_viiffffffffi"] =
            function () {
                return (dynCall_viiffffffffi = Module["dynCall_viiffffffffi"] =
                    Module["asm"]["dynCall_viiffffffffi"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiffffffffiii = (Module["dynCall_viiffffffffiii"] =
            function () {
                return (dynCall_viiffffffffiii = Module[
                    "dynCall_viiffffffffiii"
                ] =
                    Module["asm"]["dynCall_viiffffffffiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_iiiiiiiiiiiiii = (Module["dynCall_iiiiiiiiiiiiii"] =
            function () {
                return (dynCall_iiiiiiiiiiiiii = Module[
                    "dynCall_iiiiiiiiiiiiii"
                ] =
                    Module["asm"]["dynCall_iiiiiiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiiiiiiiiiii = (Module["dynCall_viiiiiiiiiiiii"] =
            function () {
                return (dynCall_viiiiiiiiiiiii = Module[
                    "dynCall_viiiiiiiiiiiii"
                ] =
                    Module["asm"]["dynCall_viiiiiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_fiiiiiifiifif = (Module["dynCall_fiiiiiifiifif"] =
            function () {
                return (dynCall_fiiiiiifiifif = Module[
                    "dynCall_fiiiiiifiifif"
                ] =
                    Module["asm"]["dynCall_fiiiiiifiifif"]).apply(
                    null,
                    arguments
                );
            });
        var dynCall_fiiiiiifiiiif = (Module["dynCall_fiiiiiifiiiif"] =
            function () {
                return (dynCall_fiiiiiifiiiif = Module[
                    "dynCall_fiiiiiifiiiif"
                ] =
                    Module["asm"]["dynCall_fiiiiiifiiiif"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viffiifffffiii = (Module["dynCall_viffiifffffiii"] =
            function () {
                return (dynCall_viffiifffffiii = Module[
                    "dynCall_viffiifffffiii"
                ] =
                    Module["asm"]["dynCall_viffiifffffiii"]).apply(
                    null,
                    arguments
                );
            });
        var dynCall_viffffiifffiiiiif = (Module["dynCall_viffffiifffiiiiif"] =
            function () {
                return (dynCall_viffffiifffiiiiif = Module[
                    ...
                    Module["asm"]["dynCall_viffffiifffiiiiif"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiiiiiiiiifii = (Module["dynCall_viiiiiiiiiiifii"] =
            function () {
                return (dynCall_viiiiiiiiiiifii = Module[
                    ...
                    Module["asm"]["dynCall_viiiiiiiiiiifii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_iiiiifiiiiif = (Module["dynCall_iiiiifiiiiif"] =
            function () {
                return (dynCall_iiiiifiiiiif = Module["dynCall_iiiiifiiiiif"] =
                    Module["asm"]["dynCall_iiiiifiiiiif"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiifiiiiif = (Module["dynCall_viiiifiiiiif"] =
            function () {
                return (dynCall_viiiifiiiiif = Module["dynCall_viiiifiiiiif"] =
                    Module["asm"]["dynCall_viiiifiiiiif"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_iiiiiifffiiifiii = (Module["dynCall_iiiiiifffiiifiii"] =
            function () {
                return (dynCall_iiiiiifffiiifiii = Module[
                    ...
                    Module["asm"]["dynCall_iiiiiifffiiifiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiiiiiiiiiiiiiiii = (Module[
            ...
            return (dynCall_viiiiiiiiiiiiiiiiii = Module[
                ...
                Module["asm"]["dynCall_viiiiiiiiiiiiiiiiii"]).apply(
                null,
                arguments
            );
        });
        ...
        var dynCall_viiffiiiiiiiii = (Module["dynCall_viiffiiiiiiiii"] =
            function () {
                return (dynCall_viiffiiiiiiiii = Module[
                    "dynCall_viiffiiiiiiiii"
                ] =
                    Module["asm"]["dynCall_viiffiiiiiiiii"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var dynCall_viiiiiiiijiii = (Module["dynCall_viiiiiiiijiii"] =
            function () {
                return (dynCall_viiiiiiiijiii = Module[
                    "dynCall_viiiiiiiijiii"
                ] =
                    Module["asm"]["dynCall_viiiiiiiijiii"]).apply(
                    null,
                    arguments
                );
            });
